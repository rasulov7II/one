...
const UsersCom = () => {
  ...
  useEffect(() => {
    ...
    return (
      <div className='   overflow-auto h-[960px]'>
         ...
         <div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
           <div class="space-y-6 overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
             <a href="#" class="overflow-hidden rounded">
               <img class="mx-auto h-44 w-44 dark:hidden" src={value?.thumbnail} alt="imac image" />
               <img class="mx-auto hidden h-44 w-44 dark:block" src={value?.thumbnail} alt="imac image" />
             </a>
             <div>
